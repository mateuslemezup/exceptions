...
@ControllerAdvice
public class CustomRestPatternExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        if (mostSpecificCause != null) {
            ...
            builder.append(exceptionName + ": " + message);
        } else {
    ...
    public final ResponseEntity handlePessoaNotFoundException(PessoaNotFoundException ex, WebRequest request) {
